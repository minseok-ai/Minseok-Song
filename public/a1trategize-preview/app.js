...
function qaStatusChip(result) {
  ...
  if (result.qa_passed === false) {
    ...
    return `<span class="status-chip warning" title="QA checklist not fully passed">Reference score: ${score}/100 · Review ${n || "?"} item(s)</span>`;
  }
  return `<span class="status-chip success">Reference score: ${score}/100 · QA passed</span>`;
}
